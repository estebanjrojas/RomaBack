...
exports.getCiudadesPorProvincia = function (req, res) {
    querySrv.getQueryResults(qCiudades.getCiudadesPorProvincia, [req.params.provincias_id])
...
exports.getCiudadesIdPorNombre = function (req, res) {
    querySrv.getQueryResults(qCiudades.getCiudadesIdPorNombre, [req.params.nombre])
