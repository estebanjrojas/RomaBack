...
exports.insertEmpleadoPersonaDomicilio = function (req, res) {
  ...
  (async () => {
    ...
    try {
      ...
      let estado_civil =
        req.body.estado_civil != undefined ? req.body.estado_civil : `null`;
      let fecha_cese =
        req.body.fecha_cese != undefined
          ? `'` + req.body.fecha_cese + `'`
          : `null`;
      let usuario_carga =
        req.body.usuario_carga != undefined
          ...
          : `null`;
      let ip_carga =
        req.body.ip_carga != undefined ? `'` + req.body.ip_carga + `'` : `null`;
      let fecha_carga =
      ...
      res
        ...
        .send({
          ...
          insertado: empleado[0],
        });
    } catch (e) {
      await client.query("ROLLBACK");
      res
        .status(400)
        .send({ mensaje: "Ocurrio un error al cargar la persona" });
      throw e;
    } finally {
      client.release();
    }
